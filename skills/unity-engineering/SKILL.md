...
description: Architect Unity 6 C# applications with scenes, prefabs, ScriptableObjects, Addressables, Input System, rendering, profiling and build automation.
---

# Unity Engineering

## Purpose
Architect Unity 6 C# applications with scenes, prefabs, ScriptableObjects, Addressables, Input System, rendering, profiling and build automation.
...
## Research synthesis
Keep runtime/editor/data concerns separate; use Input System for new projects; use ScriptableObjects for authored data; use Addressables with handle release; profile before optimizing.
...
Separate systems cleanly, use the modern Input System and asset-loading architecture intentionally, profile CPU/GPU/memory and validate on target devices/builds.
