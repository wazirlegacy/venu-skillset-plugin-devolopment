---
name: linux-windows-automation
description: Automate Linux and Windows safely using Bash, PowerShell, SSH, services, scheduled jobs, configuration-as-code, logs and permissions.
---

# Linux / Windows Automation

## Purpose
Automate Linux and Windows safely using Bash, PowerShell, SSH, services, scheduled jobs, configuration-as-code, logs and permissions.
...
## Research synthesis
Make automation idempotent, observable and reversible; use least privilege; separate discover/plan/apply/verify; inject secrets securely; verify end state rather than command success.
...
Separate discovery from mutation; make scripts idempotent, scoped, observable and safe around quoting, exit codes, signals and destructive operations.
