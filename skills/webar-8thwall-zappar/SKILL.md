---
name: webar-8thwall-zappar
description: Design WebAR experiences with image/world/face tracking, camera permissions, 3D web rendering, Unity WebGL, target training, mobile performance and migration-aware deployment.
---

# WebAR / 8th Wall / Zappar Engineering

## Purpose
Design WebAR experiences with image/world/face tracking, camera permissions, 3D web rendering, Unity WebGL, target training, mobile performance and migration-aware deployment.
...
## Research synthesis
8th Wall hosted service retired 2026-02-28; existing published experiences documented to continue until 2027-02-28. Prefer current/open engine/SDK planning for new critical systems. Zappar supports image, face and instant world tracking across WebGL/iOS/Android.
...
Account for permissions, tracking quality, device capability, asset budgets and fallbacks; treat hosted 8th Wall as legacy after its 2026 retirement and verify current Zappar APIs.
