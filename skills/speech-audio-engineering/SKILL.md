---
name: speech-audio-engineering
description: Build speech/audio pipelines for capture, resampling, loudness, codecs, VAD, ASR, diarization, TTS, streaming and browser integration.
---

# Speech / Audio Engineering

## Purpose
Build speech/audio pipelines for capture, resampling, loudness, codecs, VAD, ASR, diarization, TTS, streaming and browser integration.
...
## Research synthesis
Define sample rate/channels/latency; normalize deterministically; segment intelligently; preserve timestamps; evaluate WER plus latency, missed speech, false activation and perceived quality.
...
Track sample rate, channels, latency and codecs end-to-end; evaluate ASR/TTS quality and browser/device behavior explicitly.
