...
description: Use Git and GitHub for safe branching, history management, code review, CI/CD, releases and secure collaboration.
---

# Git / GitHub Engineering

## Purpose
Use Git and GitHub for safe branching, history management, code review, CI/CD, releases and secure collaboration.
...
## Research synthesis
Prefer small coherent commits, explicit branch policy, deterministic CI, reusable workflows, protected deployment environments, and reviewed dependency/action changes.
...
Use small reviewable commits, protected branches, reproducible CI, least-privilege permissions and OIDC for cloud authentication where supported.
