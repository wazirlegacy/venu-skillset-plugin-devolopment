...
description: Design secure reliable HTTP and event-driven backends with clear contracts, auth, authorization, idempotency, retries, rate limits, and observability.
---

# API / Backend Engineering

## Purpose
Design secure reliable HTTP and event-driven backends with clear contracts, auth, authorization, idempotency, retries, rate limits, and observability.
...
## Research synthesis
Design contracts first; define idempotency; authenticate then authorize; validate input; bound retries/timeouts; emit request IDs/traces; design webhooks/jobs for deduplication and replay.
...
Design versioned API/OpenAPI contracts, authentication and authorization, idempotency, pagination, rate limits, retries, errors and observability before implementation.
