---
name: react-nextjs-engineering
description: Architect React and Next.js applications using component purity, Server/Client Components, routing, data fetching, caching, accessibility, and performance.
---

# React / Next.js Engineering

## Purpose
Architect React and Next.js applications using component purity, Server/Client Components, routing, data fetching, caching, accessibility, and performance.
...
## Research synthesis
Use Server Components by default where suitable; use Client Components only for interactivity/browser APIs; treat effects as synchronization with external systems; define caching semantics explicitly; test critical journeys.
...
Choose Server/Client Components, caching, streaming and browser APIs deliberately; minimize client JavaScript and validate hydration/navigation behavior.
