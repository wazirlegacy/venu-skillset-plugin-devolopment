---
name: computer-use
description: Design safe browser/desktop computer-use agents using deterministic automation, model-guided interaction, screenshots/accessibility trees, verification loops and side-effect controls.
---

# Computer Use Engineering

## Purpose
Design safe browser/desktop computer-use agents using deterministic automation, model-guided interaction, screenshots/accessibility trees, verification loops and side-effect controls.
...
## Research synthesis
Prefer DOM/accessibility semantics over pixels when possible; act in small steps; isolate sessions; verify every consequential action; require confirmation for irreversible or high-impact side effects.
...
Use observe-plan-act-verify; isolate credentials/sessions, gate risky actions and verify postconditions rather than trusting UI acknowledgements.
