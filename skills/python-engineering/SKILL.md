...
description: Design, implement, review, test, package, profile, and debug production Python systems with modern typing, async I/O, concurrency, packaging, testing, observability, and maintainability.
---

# Python Engineering

## Purpose
Design, implement, review, test, package, profile, and debug production Python systems with modern typing, async I/O, concurrency, packaging, testing, observability, and maintainability.
...
## Research synthesis
Use explicit typing and runtime validation at boundaries; isolate dependencies; use async for I/O-bound concurrency; bound concurrency and timeouts; test deterministically; profile before optimizing; package reproducibly.
...
Treat packaging, typing, async/concurrency, testing, profiling, dependency isolation and reproducibility as first-class engineering concerns.
