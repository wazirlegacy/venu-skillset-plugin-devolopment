...
description: Build procedural 3D, asset pipelines, Geometry Nodes, animation, rendering, compositing and Blender automation with Python.
---

# Blender Engineering

## Purpose
Build procedural 3D, asset pipelines, Geometry Nodes, animation, rendering, compositing and Blender automation with Python.
...
## Research synthesis
Use Geometry Nodes for procedural transformations, bpy for scene/data automation, BMesh for mesh-level operations, and headless Blender for repeatable batch work; version scripts with assets.
...
Use deterministic bpy/BMesh/Geometry Nodes workflows, stable asset contracts, reproducible exports and headless execution where practical.
