...
description: Plan and execute compositing, motion graphics, expressions, procedural animation, color, render and media-processing workflows across After Effects and Blender.
---

# VFX / Motion Graphics Engineering

## Purpose
Plan and execute compositing, motion graphics, expressions, procedural animation, color, render and media-processing workflows across After Effects and Blender.
...
## Research synthesis
Treat expressions as property logic and scripts as application automation; lock delivery specs; preserve FPS/color/alpha; use procedural controls for repeated animation; validate technical delivery.
...
Validate color management, frame rate, alpha, codecs, audio sync and deterministic render settings; distinguish expressions from scripts.
