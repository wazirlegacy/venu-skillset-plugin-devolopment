---
name: financial-risk
description: Model and govern market/trading risk with VaR, Expected Shortfall, drawdown, liquidity, factor exposure, leverage, limits, stress tests and model validation.
---

# Financial Risk Engineering

## Purpose
Model and govern market/trading risk with VaR, Expected Shortfall, drawdown, liquidity, factor exposure, leverage, limits, stress tests and model validation.
...
## Research synthesis
Define portfolio/horizon/factors/liquidity; compute risk with explicit assumptions; stress historical and hypothetical shocks; set limits and kill switches; backtest forecasts; separate measurement from prediction and advice.
...
Separate signal, risk and execution; model exposure, leverage, liquidity, concentration, stress and tail risk; keep hard limits outside probabilistic reasoning.
