...
description: Design accessible consistent interfaces with component systems, design tokens, responsive layout, Figma variables, Dev Mode and usability validation.
---

# UI / UX Engineering

## Purpose
Design accessible consistent interfaces with component systems, design tokens, responsive layout, Figma variables, Dev Mode and usability validation.
...
## Research synthesis
Treat UI as a system of tokens, components, variants and states; design keyboard/focus/contrast semantics early; keep Figma as a source of truth while verifying accessibility in implementation.
...
Use design tokens/variables, responsive modes, component contracts, accessibility criteria and design-to-code handoff validation.
