---
name: typescript-javascript-engineering
description: Engineer modern JavaScript and TypeScript systems with strict type safety, ESM/CJS interoperability, runtime validation, async control flow, and maintainable modules.
---

# TypeScript / JavaScript Engineering

## Purpose
Engineer modern JavaScript and TypeScript systems with strict type safety, ESM/CJS interoperability, runtime validation, async control flow, and maintainable modules.
...
## Research synthesis
Separate compile-time types from runtime validation; make runtime boundaries explicit; use modern modules deliberately; bound async concurrency; build reproducibly.
...
Make module boundaries, ESM/CJS interop, strict typing, runtime validation, async error handling and build configuration explicit.
