---
name: mathematical-statistical-reasoning
description: Apply probability, statistics, linear algebra, calculus, optimization, numerical methods, experimental design, time series and uncertainty quantification rigorously.
---

# Mathematical / Statistical Reasoning

## Purpose
Apply probability, statistics, linear algebra, calculus, optimization, numerical methods, experimental design, time series and uncertainty quantification rigorously.
...
## Research synthesis
Define the question mathematically; state assumptions; avoid leakage; use time-aware splits for temporal data; quantify uncertainty; check calibration/residuals; compare baselines and sensitivity.
...
State assumptions, derive and sanity-check formulas, quantify uncertainty, use robust validation/calibration and distinguish prediction from causation.
