...
description: Design relational schemas, transactions, indexes, queries, migrations, concurrency, and performance plans with PostgreSQL as primary reference.
---

# SQL / Database Engineering

## Purpose
Design relational schemas, transactions, indexes, queries, migrations, concurrency, and performance plans with PostgreSQL as primary reference.
...
## Research synthesis
Model invariants in the schema; define transaction boundaries; use EXPLAIN with realistic data; index from access patterns; manage migrations, pooling, backup and restore testing.
...
Reason about constraints, MVCC, isolation, locking, indexes, planner statistics, migrations, backups and recovery before query-level optimization.
