---
name: cybersecurity
description: Perform authorized defensive security design, threat modeling, secure coding, application security verification, secrets and supply-chain defense.
---

# Cybersecurity Engineering

## Purpose
Perform authorized defensive security design, threat modeling, secure coding, application security verification, secrets and supply-chain defense.
...
## Research synthesis
Use threat modeling plus verification standards; protect auth/authz, input/output, secrets and outbound access; scan dependencies/containers/IaC; audit without leaking secrets; maintain incident/recovery procedures.
...
Apply threat modeling, OWASP Top 10:2025, API security, NIST SSDF and zero-trust principles; treat authorization, supply chain and exceptional conditions as core design concerns.
