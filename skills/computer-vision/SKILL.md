...
description: Design image/video perception pipelines with camera geometry, preprocessing, features, detection, segmentation, tracking, OCR, deep models and evaluation.
---

# Computer Vision Engineering

## Purpose
Design image/video perception pipelines with camera geometry, preprocessing, features, detection, segmentation, tracking, OCR, deep models and evaluation.
...
## Research synthesis
Define acquisition/calibration; preserve coordinate conventions; choose classical CV vs deep learning from data/latency/robustness; evaluate with task-specific metrics; test production preprocessing against evaluation.
...
Define input domain, calibration/preprocessing and error costs; evaluate task metrics plus latency and distribution shift on representative data.
