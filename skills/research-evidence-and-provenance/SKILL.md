---
name: research-evidence-and-provenance
description: Perform deep technical research with primary-source verification, version tracking, evidence grading and provenance.
metadata:
  version: "1.0"
...
---
## Purpose
Perform deep technical research with primary-source verification, version tracking, evidence grading and provenance.
...
Perform deep research from primary repositories, official documentation, specifications, standards and papers; use secondary/community sources mainly for discovery.

For each important finding preserve the claim, source, version/date, observed mechanism, confidence, limitations and contradictions. Separate technical mechanism from marketing and unverified claims.
...
Preserve source identity, version/time, transformations, evidence strength, vendor-claim labels, uncertainty, citations, and reproducible research trails.
