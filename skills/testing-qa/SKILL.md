---
name: testing-qa
description: Create layered tests for unit, integration, API contracts, browser E2E, performance, accessibility, reliability and regression.
---

# Testing / QA Engineering

## Purpose
Create layered tests for unit, integration, API contracts, browser E2E, performance, accessibility, reliability and regression.
...
## Research synthesis
Maximize signal and minimize flakiness; keep unit tests fast/deterministic, use integration/contract tests for boundaries, keep E2E focused on critical journeys, and investigate flaky tests rather than hiding them.
...
Layer tests, keep fixtures deterministic, include negative/adversarial and performance coverage, and make failures diagnostic and reproducible.
