...
description: Design secure containerized applications with Dockerfiles, Compose, Kubernetes workloads, networking, storage, probes, RBAC, secrets, and resource limits.
---

# Docker / Kubernetes Engineering

## Purpose
Design secure containerized applications with Dockerfiles, Compose, Kubernetes workloads, networking, storage, probes, RBAC, secrets, and resource limits.
...
## Research synthesis
Use minimal multi-stage images; avoid root; use seccomp/least privilege; define K8s resources, probes, RBAC, secrets and rollout/rollback explicitly; scan and verify image supply chain.
...
Use multi-stage builds, trusted/pinned images, non-root/rootless execution when practical, resource limits, probes, RBAC, network policies and secret controls.
